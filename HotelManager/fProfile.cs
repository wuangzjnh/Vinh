...
namespace HotelManager
{
    public partial class fProfile : Form
    {
        ...
        private void txbNewPass_OnValueChanged(object sender, EventArgs e)
        {
        ...
        private void txbDisplayName_OnValueChanged(object sender, EventArgs e)
        {

        }

        private void txbReNewPass_OnValueChanged(object sender, EventArgs e)
        {
